<x-app-layout>
    ...
    <div class="p-6 text-gray-900">
        ...
        <form class="w-full" method="POST" action="{{ route('consolas.update', ['consola' => $consola->id]) }}" novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="px-4 mx-6 mb-6">
                ...
                <input type="text" name="nombre"
                    ...
                    id="nombre" placeholder="Nombre de la consola" value="{{$consola->nombre}}">
                @error('nombre')
            ...
            <div class="px-4 mx-6 mb-6">
                <div class="mt-4">
                    <p class="block text-gray-500 font-bold md:text-left mb-1 md:mb-0 pr-4">Imagen actual</p>
                    <img src="/storage/{{$consola->imagen}}" style="width: 200px">
                </div>
